...
const LearnCode = () => {
  return (
    <div className=" mx-8">
      <h2 className=" text-primary text-center font-bold text-3xl m-6">
        Screen shot of Learn Code
      </h2>
      <PhotoProvider>
      ...
      <div className=" mt-6">
        <h2 className=" text-primary font-bold text-3xl my-6 underline">
          Feature
        </h2>
        <ol className=" font-bold">
          <li>* Developed in React, Express Js Bootstrap as CSS framework</li>
          <li>
            * Dynamically load data from the server and use CRUD operation
          </li>
        ...
        <a href="https://assignment-d6e68.web.app/cources">
          <button className=" btn btn-primary ">Live Link</button>
        </a>
        <a href="https://github.com/rabiul155/LearnCode-client">
          <button className=" btn btn-primary m-4">GitHub Client side </button>
        </a>
        <a href="https://github.com/rabiul155/LearnCode-server">
          <button className=" btn btn-primary m-4">GitHub Server Side</button>
        </a>
      </div>
    </div>
  );
